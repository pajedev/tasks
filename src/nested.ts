...
export function getPublishedQuestions(questions: Question[]): Question[] {
    let published = questions.filter(
...
export function sumPublishedPoints(questions: Question[]): number {
    let published = getPublishedQuestions(questions);
...
export function addNewQuestion(
    ...
    let added = [...questions, makeBlankQuestion(id, name, type)];
    return added;
}
...
export function editOption(
    ...
    let edited = questions.map((question: Question) =>
        question.id === targetId ?
            {
                ...question,
                options:
...
export function duplicateQuestionInArray(
    ...
    let duped = [...questions];
    duped.splice(index + 1, 0, duplicateQuestion(newId, questions[index]));
    return duped;
}
